...
create table task_lists (id uuid not null default gen_random_uuid(),
  created_by uuid,
...
create table tasks (id uuid not null default gen_random_uuid(),
  task_list_id uuid not null,
  created_by uuid,
  name varchar(255) not null,
  status varchar(255) not null default 'active',
